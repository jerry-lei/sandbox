...
#### distort-
`	(Verb): pull or twist out of shape`
...
#### appropriation-
`	(Noun): the action of appropriating something`
...
#### gainsay-
`	(Verb): deny or contradict (a fact or statement)`

#### hinterland-
`	(Noun): the remote areas of a country away from the coast or the banks of major rivers`
...
#### turpitude-
`	(Noun): depraved or wicked behaviour or character`

#### guileless-
`	(Adjective): devoid of guile; innocent and without deception`
...
#### epicurean-
`	(Noun): a disciple or student of the Greek philosopher Epicurus.`
`	(Adjective): relating to Epicurus or his ideas`

#### deplorable-
`	(Adjective): deserving strong condemnation; completely unacceptable`
